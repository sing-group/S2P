...
@Operation(
	name = "Import a single HTM SameSpots report",
	description = "Imports a single Progenesis SameSpots report from the generated HTM file."
)
public class ImportSameSpotsSampleRepeatedMeasuresReport {
	...
	@Port(
		...
		description = "The HTM file report generated by the Protenesis "
			+ "SameSpots software. Please, note that you must select a file "
			+ "and not a directory.",
		order = 1,
	...
	@Port(
		...
		name = "Spots suffix",
		defaultValue = "",
		description = "The suffix to add to the spots identifiers.",
		order = 4
	)
