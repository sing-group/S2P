...
/**
 * A basic transferable object useful for storing information in the system's
 * clipboard.
 * 
...
public class BasicTransferable implements Transferable, UIResource {
	...
	/**
	 * Constructs a new instance of {@link BasicTransferable}.
	 * 
	 * @param plainData the data in text/plain format.
	 * @param htmlData the data in text/html format.
	 */
	 ...
	 * plain text. If this method returns a non-null value, it will be placed
	 * at the start of the array of supported flavors.
	 * 
	 * @return an array with the flavors. This method currently returns
	 * {@code null}.
	 */
	...
	/**
	 * Some subclasses will have flavors that are more descriptive than HTML or
	 * plain text. In such cases, this method returns the data in a richer
	 * flavor.
	 * 
	 * @param flavor the flavor of the data returned.
	 * @return the data in the requested flavor. Currently, this method only 
	 * returns {@code null}.
	 ...
	 * 
	 * @return {@code true} if HTML is supported as flavor. {@code false}
	 * otherwise.
	 */
	 ...
	 * 
	 * @return the data in a text/html format.
	 */
	 ...
	 * 
	 * @return boolean indicating whether or not the plain flavor is supported.
	 */
	 ...
	 * 
	 * @return the data in text/plain format.
	 */
